...
public class CoPIGrantCountConstructQueryRunner implements ModelConstructor {
	...
	private String generateConstructQueryForKeyPersonnelRoleOfProperty(
			String queryURI, String preboundProperty, String preboundRoleType) {
		...
		String sparqlQuery = "CONSTRUCT { "
				...
				+ "?Role rdf:type " + preboundRoleType + " . "
				+ SPARQL_QUERY_COMMON_CONSTRUCT_AND_WHERE_STRING
				+ "?RelatedRole rdf:type wcmc:KeyPersonnelRole ."
				+ "?RelatedRole <http://purl.obolibrary.org/obo/RO_0000052> ?coInvestigator ."
		        + "?coInvestigator rdf:type foaf:Person  ."
				+ "?coInvestigator rdfs:label ?coInvestigatorLabel . "
				+ "}"
	...
	private String generateConstructQueryForCoInvestigatorRoleOfProperty(
			String queryURI, String preboundProperty, String preboundRoleType) {
		...
		String sparqlQuery = "CONSTRUCT { "
				...
				+ "?Role rdf:type " + preboundRoleType + " . "
				+ SPARQL_QUERY_COMMON_CONSTRUCT_AND_WHERE_STRING
				+ "?RelatedRole rdf:type wcmc:CoInvestigatorRole ."
				+ "?RelatedRole <http://purl.obolibrary.org/obo/RO_0000052> ?coInvestigator ."
		        + "?coInvestigator rdf:type foaf:Person  ."
				+ "?coInvestigator rdfs:label ?coInvestigatorLabel . "
				+ "}"
	...
	private String generateConstructQueryForPrincipalInvestigatorSubawardRoleOfProperty(
			String queryURI, String preboundProperty, String preboundRoleType) {
		...
		String sparqlQuery = "CONSTRUCT { "
				...
				+ "?Role rdf:type " + preboundRoleType + " . "
				+ SPARQL_QUERY_COMMON_CONSTRUCT_AND_WHERE_STRING
				+ "?RelatedRole rdf:type wcmc:PrincipalInvestigatorSubawardRole ."
				+ "?RelatedRole <http://purl.obolibrary.org/obo/RO_0000052> ?coInvestigator ."
		        + "?coInvestigator rdf:type foaf:Person  ."
				+ "?coInvestigator rdfs:label ?coInvestigatorLabel . "
				+ "}"
	...
	private String generateConstructQueryForPrincipalInvestigatorSubcontractRoleOfProperty(
			String queryURI, String preboundProperty, String preboundRoleType) {
		...
		String sparqlQuery = "CONSTRUCT { "
				...
				+ "?Role rdf:type " + preboundRoleType + " . "
				+ SPARQL_QUERY_COMMON_CONSTRUCT_AND_WHERE_STRING
				+ "?RelatedRole rdf:type wcmc:PrincipalInvestigatorSubcontractRole ."
				+ "?RelatedRole <http://purl.obolibrary.org/obo/RO_0000052> ?coInvestigator ."
		        + "?coInvestigator rdf:type foaf:Person  ."
				+ "?coInvestigator rdfs:label ?coInvestigatorLabel . "
				+ "}"
	...
	private void populateConstructQueries(Set<String> constructQueries) {
		...
		constructQueries
				.add(generateConstructQueryForCoPrincipalInvestigatorRoleOfProperty(
						this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "core:InvestigatorRole"));
		constructQueries
		.add(generateConstructQueryForKeyPersonnelRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "core:InvestigatorRole"));
		
		constructQueries
		.add(generateConstructQueryForCoInvestigatorRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "core:InvestigatorRole"));
		...
		constructQueries
				.add(generateConstructQueryForPrincipalInvestigatorRoleOfProperty(
						this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "core:InvestigatorRole"));
		constructQueries
				.add(generateConstructQueryForPrincipalInvestigatorSubawardRoleOfProperty(
						this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "core:InvestigatorRole"));
		constructQueries
				.add(generateConstructQueryForPrincipalInvestigatorSubcontractRoleOfProperty(
						this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "core:InvestigatorRole"));
		...
		constructQueries
		.add(generateConstructQueryForInvestigatorRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "wcmc:KeyPersonnelRole"));
		constructQueries
		.add(generateConstructQueryForKeyPersonnelRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "wcmc:KeyPersonnelRole"));
		constructQueries
		...
		constructQueries
		.add(generateConstructQueryForInvestigatorRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "wcmc:CoInvestigatorRole"));
		constructQueries
		.add(generateConstructQueryForCoInvestigatorRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "wcmc:CoInvestigatorRole"));
		constructQueries
		...
		constructQueries
		.add(generateConstructQueryForInvestigatorRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "wcmc:PrincipalInvestigatorSubawardRole"));
		constructQueries
		.add(generateConstructQueryForPrincipalInvestigatorSubawardRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "wcmc:PrincipalInvestigatorSubawardRole"));
		constructQueries.add(generateConstructQueryForDateTimeValueofRole(
		...
		constructQueries
		.add(generateConstructQueryForInvestigatorRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "wcmc:PrincipalInvestigatorSubcontractRole"));
		constructQueries
		.add(generateConstructQueryForPrincipalInvestigatorSubcontractRoleOfProperty(
				this.egoURI, "<http://purl.obolibrary.org/obo/RO_0000053>", "wcmc:PrincipalInvestigatorSubcontractRole"));
		constructQueries.add(generateConstructQueryForDateTimeValueofRole(
